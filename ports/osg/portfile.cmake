...
if (VCPKG_TARGET_IS_WINDOWS OR VCPKG_TARGET_IS_LINUX)
    ...
    list(APPEND OPTIONS -DOSG_GL1_AVAILABLE=OFF)
	list(APPEND OPTIONS -DOSG_GL2_AVAILABLE=OFF)
	list(APPEND OPTIONS -DOSG_GL3_AVAILABLE=ON)
	list(APPEND OPTIONS -DOSG_GLES1_AVAILABLE=OFF)
	list(APPEND OPTIONS -DOSG_GLES2_AVAILABLE=OFF)
	list(APPEND OPTIONS -DOSG_GLES3_AVAILABLE=OFF)
	list(APPEND OPTIONS -DOPENGL_PROFILE=GL3)
else()
    list(APPEND OPTIONS -DOSG_GL1_AVAILABLE=OFF)
	list(APPEND OPTIONS -DOSG_GL2_AVAILABLE=OFF)
	list(APPEND OPTIONS -DOSG_GL3_AVAILABLE=OFF)
	list(APPEND OPTIONS -DOSG_GLES1_AVAILABLE=OFF)
	list(APPEND OPTIONS -DOSG_GLES2_AVAILABLE=OFF)
	list(APPEND OPTIONS -DOSG_GLES3_AVAILABLE=ON)
	list(APPEND OPTIONS -DOPENGL_PROFILE=GLES3)
endif()
